      ...
      container.innerHTML += `
        <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
          <div class="h-48 overflow-hidden">
            <img src="${freelances[0].profileImage}" class="w-full h-48 object-cover" alt="Cover">
          </div>
          <div class="mx-auto w-32 h-32 -mt-16 border-4 border-white rounded-full overflow-hidden">
            <img src="${freelances[0].image}" class="w-32 h-32 object-cover" alt="Profil">
          </div>
          <div class="p-4 text-center">
            <h2 class="font-bold text-xl">${freelances[0].name}</h2>
            <p class="text-gray-600">${freelances[0].speciality}</p>
            <h2 class ="text-left font-bold">Bio</h2>
            <p class ="text-black text-left">${freelances[0].bio}</p> 
              
              <div class =" text-left">
              <h2 class="mt-4  font-bold text-left mb-3">skills:</h2>
              <ul class =" flex gap-3">
              <li class ="bg-orange-600 pl-3 pr-3 rounded-lg border-2 border-blue-500 text-white">${freelances[0].skills[0]}</li>
              <li class ="bg-orange-600 pl-3 pr-3 rounded-lg border-2 border-blue-500 text-white">${freelances[0].skills[1]}</li>
              <li class ="bg-orange-600 pl-3 pr-3 rounded-lg border-2 border-blue-500 text-white">${freelances[0].skills[2]}</li>
              <li class ="bg-orange-600 pl-3 pr-3 rounded-lg border-2 border-blue-500 text-white">${freelances[0].skills[3]}</li>
              </ul>
              </div>
              <div >
              <div class ="text-left mt-4">
             <i class="fa-solid fa-pen text-orange-600"></i> <a href="modefection.html" class="text-blue-800 font-medium">see your About info</a>
              </div>
...
<div class="grid  grid-cols-2 mt-5">
   <p class="mt-2 font-semibold">Tarif: ${freelances[0].rate} $/h</p>
    ...
    <p>${freelances[1].comment}</p>
            ...
            <a href="profil.html?id=${freelances[0].id}" 
